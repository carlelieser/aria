      ...
      >
        ...
        <Dialog.Content>
          ...
          <View style={styles.infoSection}>
            <InfoRow icon={PackageIcon} label="Version" value={buildNumber ? `${appVersion} (${buildNumber})` : appVersion} />
            ...
            <InfoRow icon={CpuIcon} label="Architecture" value={Platform.OS === 'ios' ? 'arm64' : 'arm64-v8a'} />
          </View>

          <Divider style={[styles.divider, { backgroundColor: colors.outlineVariant }]} />

          <Text variant="bodySmall" style={[styles.description, { color: colors.onSurfaceVariant }]}>
            A clean architecture music player built with Expo, React Native, and TypeScript.
        ...
        <Dialog.Actions style={styles.actions}>
          <Button
            ...
            icon={({ size, color }) => <Icon as={GithubIcon} size={size} color={color} />}
          >
            GitHub
          </Button>
