/**
 * ExploreSortSection Component
 *
 * Sort options for explore/search filtering.
 * Uses M3 theming.
 */
...
interface ExploreSortSectionProps {
...
const SORT_OPTIONS: { field: SearchSortField; label: string }[] = [
...
export function ExploreSortSection({
	sortField,
	sortDirection,
	onSortFieldChange,
	onToggleDirection,
}: ExploreSortSectionProps) {
