    ...
    if (isDownloadCompleted && downloadInfo.fileSize && downloadInfo.downloadedAt) {
      return (
        <View style={styles.statusRow}>
          ...
          <Text variant="bodySmall" style={[styles.statusText, { color: colors.onSurfaceVariant }]}>
  ...
  return (
    ...
    >
      ...
      {downloadInfo ? (
        ...
        <>
          <Text variant="bodySmall" style={[styles.duration, { color: colors.onSurfaceVariant }]}>
            {duration}
          </Text>
