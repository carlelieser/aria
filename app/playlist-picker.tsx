  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        {track && (
          <Surface style={[styles.trackPreview, { backgroundColor: `${colors.background}80` }]}>
            <Text variant="bodyMedium" numberOfLines={1} style={{ color: colors.onSurface, fontWeight: '500' }}>
              {track.title}
            </Text>
