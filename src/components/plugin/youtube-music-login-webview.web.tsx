/**
 * YouTube Music Login WebView Component (Web Platform)
 *
 * Web platform stub - YouTube Music login via WebView is only available on native platforms.
 */
	...
	return (
		<View style={[styles.container, { backgroundColor: colors.background }]}>
			...
			<View style={styles.content}>
				...
				>
					YouTube Music login requires native cookie access and is only available on iOS
					and Android devices.
				</Text>
			</View>
		</View>
