/**
 * YouTube Music Metadata Provider Plugin
 *
 * Provides music metadata and streaming capabilities using YouTube Music
 * via the youtubei.js library.
 */
...
// Install evaluator at module load
installEvaluator();

/**
 * YouTube Music Provider
 *
 * Implements both MetadataProvider and AudioSourceProvider interfaces.
 */
