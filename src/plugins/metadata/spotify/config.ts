...
/**
 * Spotify Provider configuration interface
 */
...
/**
 * Required OAuth scopes for library access
 */
...
export const PLUGIN_MANIFEST: PluginManifest = {
  ...
  description: 'Access your Spotify library including playlists, saved tracks, albums, and followed artists',
  version: '1.0.0',
  author: 'Aria',
...
/**
 * Metadata capabilities provided by this plugin
 */
