/**
 * DASH Playback Provider Plugin
 * Handles DASH manifest URLs for audio streaming using expo-video
 */
...
/**
 * Check if a URL is a DASH manifest data URI
 */
      ...
      case 'readyToPlay':
        if (this.player) {
          ...
          if (durationSec && durationSec > 0) {
            ...
            this.emitEvent({ type: 'duration-change', duration: this.duration, timestamp: Date.now() });
          }
        }
        this.updateStatus('playing');
        break;
