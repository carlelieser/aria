/**
 * Aggregated Library Utilities
 *
 * Pure mapper and computation functions for aggregating library data
 * from multiple sources (main library + local library).
 */
...
export const LOCAL_LIBRARY_SOURCE = 'local-library';
...
export function mapLocalAlbumToUniqueAlbum(localAlbum: LocalAlbum): UniqueAlbum {
	return {
...
export function mapLocalArtistToUniqueArtist(
...
export function computeAggregatedTracks(
	libraryTracks: Track[],
...
export function computeAggregatedArtists(
	libraryTracks: Track[],
...
export function computeAggregatedAlbums(
	libraryTracks: Track[],
